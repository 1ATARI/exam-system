                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <select id="correct" class="form-control" name="correct_answer" required>
                                    <option value="" selected disabled> Select Answers</option>
                                        ...
                                        <option value="option_a" {{Request()->correct_answer =='option_a' ? 'selected' :   ''}}>A</option>
                                        <option value="option_b" {{Request()->correct_answer =='option_b' ? 'selected' :   ''}}>B</option>
                                        <option value="option_c" {{Request()->correct_answer =='option_c' ? 'selected' :   ''}}>C</option>
                                        <option value="option_d" {{Request()->correct_answer =='option_d' ? 'selected' :   ''}}>D</option>
